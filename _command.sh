...
sudo yt-dlp -S "+res:480,ext:mp4,vcodec:av1" --embed-thumbnail --convert-thumbnails jpg --sponsorblock-mark all --embed-metadata --download-archive wendover.txt https://www.youtube.com/c/Wendoverproductions/videos -o '%(channel)s/%(upload_date>%Y-%m-%d ) s%(title)s.%(ext)s' --windows-filenames --trim-filenames 150 --embed-subs --sub-langs en --remux-video mkv --playlist-reverse -q

#LowSpec Gamer
sudo yt-dlp -S "+res:480,ext:mp4,vcodec:av1" --embed-thumbnail --convert-thumbnails jpg --sponsorblock-mark all --embed-metadata --download-archive lowSpecGamer.txt https://www.youtube.com/c/LowSpecGamer/videos -o '%(channel)s/%(upload_date>%Y-%m-%d ) s%(title)s.%(ext)s' --windows-filenames --trim-filenames 150 --embed-subs --sub-langs en --remux-video mkv --playlist-reverse -q

#Tech Tangents
sudo yt-dlp -S "+res:480,ext:mp4,vcodec:av1" --embed-thumbnail --embed-metadata --download-archive techtangents.txt https://www.youtube.com/c/AkBKukU/videos -o '%(channel)s/%(upload_date>%Y-%m-%d ) s%(title)s.%(ext)s' --windows-filenames --trim-filenames 150 --embed-subs --sub-langs en --remux-video mkv --playlist-reverse -q
